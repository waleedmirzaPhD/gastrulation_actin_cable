...
all_velocities = {}
file_list = sorted(os.listdir("input_20"))[:11]

for idx, file in enumerate(file_list, start=1):
    img = imread(f"input_20/{file}")
    m = {}
    ...
    for i in range(0, step * n_plots, step):  
        ...
        vectorx[vectorx < 0.0002] = 0
        vectory[vectory < 0.0002] = 0
    ...
    # micron_positions = [9.5, 10.0, 11, 11.5, 12, 12.5]
    micron_positions = [13.0, 13.5, 14, 14.5, 15, 15.5]
    velocities = {}
    for i, j in m.items():
