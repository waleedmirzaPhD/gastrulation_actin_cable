...
#CABLE
gamma = 0.95    # active tension in the cable
eta = 1.E2      # viscosity of actin cable
l = 0.1*L       # hydrodynamic length in the cable
#-------------------
...
def compute_sigma_y(sigma_e, f_dot_h_H, dt):
    sigma_y = gamma*dt + (sigma_e - gamma*dt) * jnp.cosh(L/l) + (eta / l) * f_dot_h_H * jnp.sinh(L/l) 
    # print(sigma_e, sigma_y) 
    return sigma_y
